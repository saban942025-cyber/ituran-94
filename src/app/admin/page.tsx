...
export default function GaliaCyberDashboard() {
  ...
  const [isProcessing, setIsProcessing] = useState(false); // הנה המשתנה שהיה חסר
  ...
  return (
    <div className="dashboard-container">
      ...
      <style jsx>{`
        .dashboard-container { background: #0a0a0a; color: #e0e0e0; min-height: 100vh; font-family: sans-serif; direction: rtl; }
